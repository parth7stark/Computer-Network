...
int main(int argc, char *argv[])
{
    ...
    //unordered_map<char,string> m;
    char en_msg[100];
    recv(newSd,&en_msg,sizeof(en_msg),0);

    string text = "encoded message received: ";
    cout<<text<<en_msg<<endl;
    //send(newSd,&text,sizeof(text),0);
    //while(recv(newSd,&m,sizeof(m),0))
    ...
    //you can send n_bits or calculate
    //int n_bits = 2;
